...
public:
    ...
    EmgRTControl( MahiExoIIEmg& meii, Daq& daq, Watchdog& watchdog);
...
private:
    ...
    Time init_backdrive_time_ = seconds(2.0); /// [s] time to be in backdrive mode initially
    Time hold_center_time_ = seconds(1.0); /// [s] time to hold at center target
    Time hold_target_time_ = seconds(1.0); /// [s] time to hold at target
    Time wait_mvc_time_ = seconds(0.5); /// [s] time to wait during MVC
    Time detection_expire_time_ = seconds(10.0); /// [s] time after which failure to detect active state is marked as misclassification
    ...
    /// UNITY INPUT/OUTPUT
    std::vector<double> SCENE_NUM_ = { 0 }; /// capitalized because it is the external data provided from GUI and should be handled carefully!
    std::vector<double> viz_target_num_ = { 0 };
    MelNet scene_num_share_;
    MelNet viz_target_num_share_;
    MelNet force_mag_share_;
    MelNet hand_select_;
    MelNet pos_net_;
    MelNet state_net_;
    ...
    MahiExoIIEmg::EmgDataBuffer emg_calibration_data_buffer_ = MahiExoIIEmg::EmgDataBuffer(meii_.N_emg_, emg_calibration_window_length_);
    MahiExoIIEmg::EmgDataBuffer emg_classification_data_buffer_ = MahiExoIIEmg::EmgDataBuffer(meii_.N_emg_, emg_classification_window_length_);
    ...
    /// DATA LOG
    //DataLog<double, double, double, double, double,
    ...
    //    double, double, double, double, double, double, double, double, double, double, double, double,
    //    double, double, double, double, double, double> robot_log_;
    DataLog<double, double, double, double,
        double, double, double,
        double, double, double,
        double, double, double,
        double, double, double, int> robot_log_;
    DataLog<double, double, double, double, double, double, double, double, double,
        double, double, double, double, double, double, double, double, int> emg_log_;
    ...
    std::vector<double> feature_extract(const MahiExoIIEmg::EmgDataBuffer& emg_data_buffer) const;
