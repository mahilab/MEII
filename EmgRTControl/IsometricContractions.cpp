...
IsometricContractions::IsometricContractions(util::Clock& clock, core::Daq* daq, exo::MahiExoIIEmg& meii) :
    StateMachine(12),
    clock_(clock),
    daq_(daq),
    meii_(meii)
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_wait_for_gui(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_init(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_backdrive(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_init_rps(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_to_center(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_hold_center(const util::NoEventData* data) {
    ...
    util::print("Enter the next class label to be presented, or press escape to finish current session.");
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_present_target(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_process_emg(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_train_classifier(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_classify(const util::NoEventData* data) {
...
//-----------------------------------------------------------------------------
void IsometricContractions::sf_finish(const util::NoEventData* data) {
...
void IsometricContractions::sf_stop(const util::NoEventData* data) {
...
int IsometricContractions::check_for_user_input_target() {
    util::Input::Key key;
    if (is_single_dof()) {
        key = util::Input::are_any_keys_pressed({ util::Input::Key::Num1, util::Input::Key::Num2, util::Input::Key::Escape }, true);
        switch (key) {
        case util::Input::Key::Num1:
            return 1;
            break;
        case util::Input::Key::Num2:
            return 2;
            break;
        case util::Input::Key::Escape:
            return -1;
            break;
        default: return 0;
        }
        ...
        key = util::Input::are_any_keys_pressed({ util::Input::Key::Num1, util::Input::Key::Num2, util::Input::Key::Num3, util::Input::Key::Num4, util::Input::Key::Escape }, true);
        switch (key) {
        case util::Input::Key::Num1:
            return 1;
            break;
        case util::Input::Key::Num2:
            return 2;
            break;
        case util::Input::Key::Num3:
            return 3;
            break;
        case util::Input::Key::Num4:
            return 4;
            break;
        case util::Input::Key::Escape:
            return -1;
...
bool IsometricContractions::check_stop() {
    return (util::Input::is_key_pressed(util::Input::LControl) && util::Input::is_key_pressed(util::Input::C));
}
...
double IsometricContractions::measure_task_force(double_vec commanded_torques, int target_num, int dof, int condition) const {
...
double_vec IsometricContractions::feature_extract(exo::MahiExoIIEmg::EmgDataBuffer& emg_data_buffer) {
...
void IsometricContractions::ar4_feature_extract(double_vec& coeffs, const double_vec& emg_channel_buffer) {
