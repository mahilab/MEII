...
#ms_numfeats = MelShare("num_feats")
ms_numelec = MelShare("num_elec")
...
num_elec = ms_numelec.read_data()
num_feats = num_elec[0]*9

# extract training data and training labels from file data
X = array[:,0:int(num_feats)-1]
Y = array[:,int(num_feats)]
